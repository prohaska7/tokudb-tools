...
cmake -DCMAKE_BUILD_TYPE=$buildtype -DTOKUDB_NOPATCH_CONFIG=1 -DDOWNLOAD_BOOST=1 -DWITH_BOOST=$HOME/boost -DZLIB_INCLUDE_DIR=/usr/include ../mysql-5.7.7-labs-json
make -j8 package
popd
